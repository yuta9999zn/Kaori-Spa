...
export default function LoginForm() {
  ...
  const [email, setEmail] = useState('owner@naturalbeauty.vn');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-ivory via-brand-cream to-brand-lavender/30 flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        <header className="text-center mb-8">
          ...
          <p className="text-xs uppercase tracking-[0.25em] text-brand-textmuted mt-1">Organization Console · Kaori</p>
        </header>
